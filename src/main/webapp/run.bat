...
curl.exe --output jars\javafx-controls-17-win.jar --url https://repo1.maven.org/maven2/org/openjfx/javafx-controls/17/javafx-controls-17-win.jar
curl.exe --output jars\javafx-base-17-win.jar --url https://repo1.maven.org/maven2/org/openjfx/javafx-base/17/javafx-base-17-win.jar
curl.exe --output jars\javafx-fxml-17-win.jar --url https://repo1.maven.org/maven2/org/openjfx/javafx-fxml/17/javafx-fxml-17-win.jar
curl.exe --output jars\javafx-graphics-17-win.jar --url https://repo1.maven.org/maven2/org/openjfx/javafx-graphics/17/javafx-graphics-17-win.jar
...
:: sign jar file
jarsigner -keystore devKeys jars\javafx-base-17-win.jar devName
jarsigner -keystore devKeys jars\javafx-controls-17-win.jar devName
jarsigner -keystore devKeys jars\javafx-graphics-17-win.jar devName
jarsigner -keystore devKeys jars\javafx-fxml-17-win.jar devName
